...
if __name__ == "__main__":
    for iteration in range(1,5):
        random_points = generate_random_points(num_points=(iteration+1)*5, min_value=0, max_value=(iteration+1)*10)
        ...
        for algorithm in algorithms:
            ...
            convex_hull_result = convex_hull_object.compute(random_points)
